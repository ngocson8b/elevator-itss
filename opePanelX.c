         ...
         gpointer user_data)
{
    ...
    switch(my_floor_number){
        case 5:
            ...
            up_down_btn = gtk_button_new_with_label("Tầng 5");
        break;
        case 4:
            up_down_btn = gtk_button_new_with_label("Tầng 4");
            gtk_window_move(GTK_WINDOW(window),550,260);
        break;
        case 3:
            up_down_btn = gtk_button_new_with_label("Tầng 3");
            gtk_window_move(GTK_WINDOW(window),550,370);
        break;
        case 2:
            up_down_btn = gtk_button_new_with_label("Tầng 2");
    ...
    // button x
    call_btn = gtk_button_new_with_label("Bấm gọi");
